            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {chatLoading ? (
                ...
                selectedLead.message ? (
                  <div>
                    <p className="text-xs text-foreground/40 mb-3 text-center">Kapcsolatfelvételi üzenet</p>
                    <div className="flex justify-end">
                      <div className="max-w-[80%] px-4 py-2.5 rounded-xl text-sm bg-purple-600/20 text-foreground/80 rounded-br-md whitespace-pre-wrap">
                        {selectedLead.message}
                      </div>
                    </div>
                  </div>
